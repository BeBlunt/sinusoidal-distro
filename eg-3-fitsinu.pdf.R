...
### Normal
fitsinu.pdf.curve('dnorm(x,4,59)', xlim=c(-180, 180))

### Chisq
fitsinu.pdf.curve('dchisq(x, 14)', xlim=c(1,33))

### t
fitsinu.pdf.curve('dt(x,7)')

# Exponential
fitsinu.pdf.curve('dexp(x, 3.2)', xlim=c(0,1.2))

### GAMMA
fitsinu.pdf.curve('dgamma(x,3,6)', xlim=c(0, 1.8))

### BETA
fitsinu.pdf.curve('dbeta(x,3,6)', xlim=c(0, 0.8))